...
function fig4_8(data) {
    ...
    data.forEach(e => {
        let sum = 0;
        e.Year = +e.Year;
        e["Electric baseboard"] = +e["Electric baseboard"];
        ...
        e["Wood and pellets stoves"] = +e["Wood and pellets stoves"];
        e["Geothermal & solar systems"] = +e["Geothermal & solar systems"];
    ...
    .domain([0, d3.max(data, d => d.sum)+183])
    .range([275, 0]);
    ...
    .append("figcaption").text("Fig 4.8 - Space heating systems in the residential sector");
}