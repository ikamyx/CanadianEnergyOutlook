...
function stackedBarChart(data, metadata, colors) {
    ...
    // scale for Y
    let yAxisHeight = height - padding.top - padding.bottom - figureTitleMargin - titleHeight - mainTickMargin - minTickFontHeight;
