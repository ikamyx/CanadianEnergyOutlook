...
function scatterPlot(data, metadata) {
    ...
    .domain([d3.min(data, d=> d.value1), d3.max(data, d=> d.value1)])
    .range([yAxisHeight, 0]);
    ...
    //scale for X
    let xAxisWidth = width - padding.left - padding.right - yAxisWidth - yAxisLabelMargin - yAxisLabelHeight - yAxisLineWidth;
    let scaleX = d3.scaleLinear()
    .domain([d3.min(data, d=> d.value2), d3.max(data, d=> d.value2)])
    .range([xAxisWidth, 0]);
