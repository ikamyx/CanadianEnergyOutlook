(function() {
  ...
  // if (typeof define !== 'undefined') define('save-svg', [], () => out$);
  // out$.default = out$;
  ...
  //   let emptySvgDeclarationComputed = getComputedStyle(emptySvg);
  //   let SVGSources = getSources(el, emptySvgDeclarationComputed);
  //   download(SVGSources[0]);
  // };
