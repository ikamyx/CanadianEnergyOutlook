...
function fig5_4(data) {
    ...
    data.forEach(e => {
        ...
        e.Year = +e.Year;
        e.Manure = +e.Manure;
        e["Corn - Wheat"] = +e["Corn - Wheat"];
        e["Soy - Canola - Greasy residues"] = +e["Soy - Canola - Greasy residues"];
        e["Forestry residues"] = +e["Forestry residues"];
        e["Agriculture residues"] = +e["Agriculture residues"];
        e["Industrial residues"] = +e["Industrial residues"];
        e["Pulp & paper waste"] = +e["Pulp & paper waste"];
        e["Organic municipal waste"] = +e["Organic municipal waste"];
        e["Landfill biogas"] = +e["Landfill biogas"];
        e["Sewage sludge"] = +e["Sewage sludge"];
        e["Dedicated culture"] = +e["Dedicated culture"];
    ...
    .domain([0, d3.max(data, d => d.sum)+90])
    .range([275, 0]);
    ...
    .append("figcaption").text("Fig 5.4 - Bioenergy source by type");
}