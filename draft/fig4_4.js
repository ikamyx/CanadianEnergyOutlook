...
function fig4_4(data) {
    ...
    data.forEach(e => {
        ...
        e["Electricity - Centralized"] = +e["Electricity - Centralized"];
        e["Electricity - Solar PV"] = +e["Electricity - Solar PV"];
        e["Oil products"] = +e["Oil products"];
        e["Natural gas"] = +e["Natural gas"];
        e["Geo and solar thermal"] = +e["Geo and solar thermal"];
        e["Energy conservation"] = +e["Energy conservation"];
    ...
    .domain([0, d3.max(data, d => d.sum)+150])
    .range([275, 0]);
    ...
    .append("figcaption").text("Fig 4.4 - Final energy consumption in residential, commercial and agricultural sectors");
}