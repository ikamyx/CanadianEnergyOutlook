...
function fig5_6(data) {
    ...
    data.forEach(e => {
        let sum = 0;
        e.Year = +e.Year;
        e["Industrial uses"] = +e["Industrial uses"];
        e["Space heating"] = +e["Space heating"];
        e["Electricity generation"] = +e["Electricity generation"];
        e["Pellet production"] = +e["Pellet production"];
        e["Biofuel production"] = +e["Biofuel production"];
        e["Renewable natural gas production"] = +e["Renewable natural gas production"];
    ...
    .domain([0, d3.max(data, d => d.sum)+120])
    .range([275, 0]);
    ...
    .append("figcaption").text("Fig 5.6 - Primary biomass uses by type");
}